...
class ProjectsController extends Controller 
{
  ...
  public function store(Request $request)
  {
    ...
    $newEntry->src4 = $request->file("src4")->hashName();
    $request->file("src4")->storePublicly("images", "public");

    $newEntry->src5 = $request->file("src5")->hashName();
    $request->file("src5")->storePublicly("images", "public");
  ...
  public function update($id, Request $request)
  {
    ...
    Storage::disk('public')->delete('images/'.$newEntry->src4);
    $newEntry->src4 = $request->file("src4")->hashName();
    $request->file("src4")->storePublicly("images", "public");

    Storage::disk('public')->delete('images/'.$newEntry->src5);
    $newEntry->src5 = $request->file("src5")->hashName();
    $request->file("src5")->storePublicly("images", "public");
